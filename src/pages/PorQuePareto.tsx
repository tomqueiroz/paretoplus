...
export default function PorQuePareto() {
  ...
  return (
    <div style={{ background: '#F8F6F3', fontFamily: "'Playfair Display', Georgia, serif", color: '#fff' }}>
      ...
      <section className="relative min-h-[76vh] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          backgroundImage: 'linear-gradient(#DDD7CF 1px, transparent 1px), linear-gradient(90deg, #DDD7CF 1px, transparent 1px)',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pb-20 pt-36">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.9 }}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8"
              ...
              <span className="text-[11px] font-black tracking-[0.25em] uppercase" style={{ color: '#13100C' }}>
                Holding Pareto · 13 Anos · São Paulo + Palo Alto
              </span>
            </div>
            <h1 className="mb-6" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 700, fontSize: 'clamp(2.6rem, 5vw, 4.5rem)', letterSpacing: '-2px', lineHeight: 1.05, color: '#fff' }}>
              Por que a Pareto é<br />
              <span style={{ background: 'linear-gradient(90deg, #13100C 0%, #4A4540 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              ...
              <Heading className="text-2xl md:text-3xl mb-6">
                ...
                <span style={{ color: '#13100C' }}>Construímos vantagem competitiva.</span>
              </Heading>
              <Body className="mb-5">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="text-center mb-14">
            ...
            <Heading className="text-2xl md:text-3xl mb-5">
              ...
              <span style={{ color: '#13100C' }}>execução que gera resultado tangível.</span>
            </Heading>
                ...
                <Reveal key={s.n} delay={idx * 0.08} className={`lg:flex items-start gap-8 ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                  ...
                  <div className="hidden lg:flex w-10 items-center justify-center flex-shrink-0 mt-6">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center font-black text-xs"
                      style={{ background: '#13100C', color: '#fff', boxShadow: '0 0 20px rgba(136,0,255,0.4)' }}>
                      {s.n}
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="text-center mb-14">
            ...
            <Heading className="text-2xl md:text-3xl mb-5">
              ...
              <span style={{ color: '#13100C' }}>Vantagem que nenhum concorrente oferece.</span>
            </Heading>
            <Body className="max-w-2xl mx-auto text-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            ...
            <Reveal>
              <div className="p-8 rounded-2xl h-full" style={{ background: '#F8F6F3', border: `1px solid #BFB8AE` }}>
                <div className="text-xs font-black tracking-widest uppercase mb-3" style={{ color: '#13100C' }}>Vertical I</div>
                <div className="text-3xl font-black text-white mb-2">Pareto Plus</div>
                <p className="text-sm font-bold mb-5" style={{ color: '#13100C' }}>Consultoria Estratégica de IA Aplicada</p>
                ...
                <ul className="space-y-2">
                  {['Diagnóstico e priorização de uso de IA por processo',
                    ...
                    <li key={i} className="flex items-start gap-2.5 text-sm" style={{ color: '#8A8278', fontWeight: 300 }}>
                      <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: '#13100C' }} />{i}
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}
            ...
            {AWARDS.filter(a => a.highlight).map(a => (
              <motion.div key={a.title} variants={staggerItem} className="p-5 rounded-2xl"
                ...
                <div className="text-[10px] font-bold" style={{ color: '#13100C' }}>{a.org}</div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="text-center mb-12">
            ...
            <Heading className="text-xl md:text-2xl mb-4">
              ...
              <span style={{ color: '#13100C' }}>É fundamento inegociável.</span>
            </Heading>
          </Reveal>
