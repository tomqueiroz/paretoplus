...
export default function Home() {
  ...
  return (
    <>
      ...
      <main style={{ background: '#0D0D0D', color: '#fff', fontFamily: "'Roboto', sans-serif" }}>
        ...
        <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'linear-gradient(to bottom, rgba(13,13,13,0) 45%, rgba(13,13,13,1) 100%)' }} />
        ...
        {/* ─── Credibility bar ─────────────────────────────────────── */}
        <div style={{ background: 'rgba(12,12,12,1)', borderTop: '1px solid rgba(136,0,255,0.1)', borderBottom: '1px solid rgba(136,0,255,0.1)' }}>
          <div className="max-w-7xl mx-auto px-6 py-5 flex flex-wrap items-center justify-center gap-5">
            {PARTNER_BADGES.map((b) => (
              <div key={b.name} className="flex items-center gap-2 px-4 py-2 rounded-full"
        ...
        ═══════════════════════════════════════════════════ */}
        <section id="problema" className="py-28 relative overflow-hidden" style={{ background: 'rgba(14,14,14,0.95)' }}>
        ...
        ═══════════════════════════════════════════════════ */}
        <section id="pareto" className="py-28 relative" style={{ background: 'rgba(14,14,14,0.95)' }}>
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <RevealSection className="text-center mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn}>
                <img src="/images/tess_ai_illustration.png" alt="Tess AI" className="w-full rounded-2xl"
                  style={{ border: '1px solid rgba(136,0,255,0.2)', boxShadow: '0 0 80px rgba(136,0,255,0.18)' }} loading="lazy" />
              </motion.div>
              <RevealSection>
        ...
        {/* ─── Client Marquee ──────────────────────────────────────── */}
        <section className="py-16" style={{ background: 'rgba(10,10,10,0.98)' }}>
        ...
        ═══════════════════════════════════════════════════ */}
        <section id="parceria" className="py-28 relative" style={{ background: 'rgba(14,14,14,0.98)' }}>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} className="space-y-5">
                ...
                {/* AI agents visual */}
                <img src="/images/ai_agents_illustration.png" alt="AI Agents" className="w-full rounded-2xl"
                  style={{ border: '1px solid rgba(136,0,255,0.12)', boxShadow: '0 0 40px rgba(136,0,255,0.1)' }} loading="lazy" />
              </motion.div>
            </div>
          </div>
        </section>
        ...
        {/* ─── Futurism image break ────────────────────────────────── */}
        <div className="relative h-64 md:h-80 overflow-hidden">
          <img src="/images/brazil_business_futurism.png" alt="" aria-hidden
            className="absolute inset-0 w-full h-full object-cover" style={{ opacity: 0.28, filter: 'saturate(1.2)' }} />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(13,13,13,0.97) 0%, rgba(13,13,13,0.5) 50%, rgba(13,13,13,0.97) 100%)' }} />
          <div className="relative z-10 flex items-center justify-center h-full px-6">
            <RevealSection className="text-center">
              <p className="text-lg md:text-xl font-bold text-white leading-snug" style={{ fontFamily: "'Roboto', sans-serif" }}>
                O Brasil de 2030 já está sendo construído.<br />
                <span style={{ color: '#CDFF00' }}>Por quem agiu em 2026.</span>
              </p>
            </RevealSection>
          </div>
        </div>
        ...
        ═══════════════════════════════════════════════════ */}
        <section className="py-28 relative" style={{ background: 'rgba(13,13,13,1)' }}>
          <div className="max-w-5xl mx-auto px-6 lg:px-8">
            <RevealSection className="text-center mb-20">
